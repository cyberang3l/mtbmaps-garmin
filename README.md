...
2. Generate the MTB map overlay by running the `make <country>` command after you clone
   this repository. If everything works, you should find a gmapsupp file named
   `YYYY-MM-DD-mtbmap-<country>.img` in the `out` directory. All you need to do
